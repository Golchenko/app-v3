import { Card, Button, TextField, Toast } from "@shopify/polaris";
...
export default function CustomJsInput() {
    ...
    const [isSaveCode, setIsSaveCode] = useState(false);
    ...
    const toastSaveCode = (isSaveCode) ? (
        <Toast
            content={isSaveCode}
            onDismiss={() => { setIsSaveCode(false) }}
            duration={2000}
        />
    ) : null;
